...
const LocaleLayout = async ({
  ...
  const datasetMap: Record<DatasetAttr, string | undefined> = {
    ...
    [DatasetAttr.DATA_PUBLIC_PLUGIN_INSTALL_AMD_API_PREFIX]: process.env.NEXT_PUBLIC_PLUGIN_INSTALL_AMD_URL,
    [DatasetAttr.DATA_PUBLIC_PLUGIN_INSTALL_ARM_API_PREFIX]: process.env.NEXT_PUBLIC_PLUGIN_INSTALL_ARM_URL,
  }
